...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const templateData = {
      ...
      amountUsd: amountUsd.toLocaleString('en-CA', { style: 'currency', currency: 'CAD' }),
      feeUsd: feeUsd.toLocaleString('en-CA', { style: 'currency', currency: 'CAD' }),
      totalUsd: totalUsd.toLocaleString('en-CA', { style: 'currency', currency: 'CAD' }),
