    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center gap-2">
            ...
            <div className="flex max-w-full min-w-0 items-center gap-1 overflow-x-auto rounded-full border border-border bg-muted/40 p-1 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
              {(
                [
                ...
                {total > 1 && createPortal(
                  <>
                    <button
                      ...
                      className={`fixed left-4 top-1/2 -translate-y-1/2 z-[70] flex items-center gap-1.5 px-3 py-2 rounded-lg bg-white/15 text-white hover:bg-white/25 backdrop-blur focus:opacity-100 transition-opacity duration-200 ${showNav ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"}`}
                    ...
                    <button
                      ...
                      className={`fixed right-4 top-1/2 -translate-y-1/2 z-[70] flex items-center gap-1.5 px-3 py-2 rounded-lg bg-white/15 text-white hover:bg-white/25 backdrop-blur focus:opacity-100 transition-opacity duration-200 ${showNav ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"}`}
