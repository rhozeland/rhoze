                ...
                {total > 1 && createPortal(
                  <>
                    <button
                      ...
                      className={`fixed left-4 top-1/2 -translate-y-1/2 z-[60] flex items-center gap-1.5 px-3 py-2 rounded-lg bg-white/15 text-white hover:bg-white/25 backdrop-blur focus:opacity-100 transition-opacity duration-200 ${showNav ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"}`}
