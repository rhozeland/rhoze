    ...
    <footer className="py-12 px-6 border-t border-border">
      <div className="container mx-auto max-w-6xl flex flex-col sm:flex-row items-center justify-between gap-6">
        <div className="flex items-center gap-2.5">
          <img src={logoBlack} alt="Rhozeland logo" className="w-6 h-6 object-contain dark-hide" />
          <img src={logoWhite} alt="Rhozeland logo" className="w-6 h-6 object-contain light-hide" />
